...
public class Hiburan extends AppCompatActivity implements NewsAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Hiburan.this, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onError(ANError anError) {
                        Toast.makeText(Hiburan.this, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show();
                        mProgressBar.setVisibility(View.GONE);
                    }
                });
    }
    ...
    private void showNews() {
        newsAdapter = new NewsAdapter(Hiburan.this, modelNews, this);
        rvHeadNews.setAdapter(newsAdapter);
    }

    @Override
    public void onSelected(ModelNews mdlNews) {
        startActivity(new Intent(Hiburan.this, DetailBerita.class).putExtra("url", mdlNews.getUrl()));
    }
